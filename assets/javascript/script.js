...
const collectEmployees = function() {
  ...
  while(response){
  employeeData={
  firstName:prompt('Enter the First Name of Employee'),
  lastName:prompt('Enter the Last Name of Employee'),
  salary:parseInt(prompt('Enter the Salary of Employee'))}
  response=window.confirm("Do you want to continue?");
